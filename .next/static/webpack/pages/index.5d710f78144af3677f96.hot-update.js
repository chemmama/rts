...
var Home = /*#__PURE__*/function (_React$Component) {
  ...
  Object(C_Users_famil_Desktop_emile_programmation_site_emile_rts_rts_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Home, [{
    ...
    value: function handleSubmit(e) {
      ...
      this.state.proprio === "" ? alert("Selectionnez un choix") : this.state.salarie === "" ? alert("Selectionnez un choix") : this.state.chauffage === "" ? alert("Selectionnez un choix") : this.state.famille === "" ? alert("Selectionnez un choix") : this.state.fiscalité === "" ? alert("Selectionnez un choix") : function (data, r) {
        alert("Thank you for your message from ".concat(data.email));
        ...
        var sendFeedback = function sendFeedback(serviceID, templateId, variables) {
          window.emailjs.send(serviceID, templateId, variables).then(function (res) {
            console.log('Email successfully sent!');
          })["catch"](function (err) {
            return console.error('There has been an error.  Hconst onSubmit = ere some thoughts on the error that occured:', err);
          });
        };
      };
    }
